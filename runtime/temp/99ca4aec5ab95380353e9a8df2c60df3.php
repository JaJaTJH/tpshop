<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\PHP\phpstudy_pro\WWW\tpshop\public/../application/admin\view\goods\goods_edit.html";i:1678268940;s:65:"D:\PHP\phpstudy_pro\WWW\tpshop\application\admin\view\layout.html";i:1678332624;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<script
    type="text/javascript"
    charset="utf-8"
    src="/plugins/ueditor/ueditor.all.min.js"
> </script>
...
<script
    type="text/javascript"
    charset="utf-8"
    src="/plugins/ueditor/lang/zh-cn/zh-cn.js"
></script>
<!-- 右 -->
<div class="content">
    <div class="header">
    ...
    <!-- edit form -->
    <form
        action="<?php echo url('admin/goods/update'); ?>"
        method="post"
        id="tab"
        ...
        <div class="tab-content">
            ...
            >
                <div class="well">
                    ...
                    <input
                        type="text"
                        name="goods_price"
                        value="<?php echo $goods['goods_price']; ?>"
                        class="input-xlarge"
                    >
                    <label>商品数量：</label>
                    <input
                        type="text"
                        name="goods_number"
                        value="<?php echo $goods['goods_number']; ?>"
                        class="input-xlarge"
                    >
                    <label>商品logo：</label>
                    <input
            ...
            >
                <div class="well">
                    ...
                    ><?php echo $goods['goods_introduce']; ?></textarea>
                </div>
            </div>
            <div
                class="tab-pane fade in"
