<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\PHP\phpstudy_pro\WWW\tpshop\public/../application/admin\view\goods\goods_detail.html";i:1678239066;s:65:"D:\PHP\phpstudy_pro\WWW\tpshop\application\admin\view\layout.html";i:1678332624;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="sidebar-nav">
    ...
    <div class="content">
        ...
        <div class="well">
            ...
            <label>商品图片：</label>
            <div><img src="<?php echo $goods['goods_logo']; ?>"></div>
            <label>商品简介：</label>
