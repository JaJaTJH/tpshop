<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\PHP\phpstudy_pro\WWW\tpshop\public/../application/admin\view\login\login.html";i:1678334345;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="login-bg">
    <div class="login-box">
        ...
        <div class="login-main">
            <form
                action="<?php echo url('admin/login/login'); ?>"
                class="form"
                method="post"
            >
                <div class="form-item">
